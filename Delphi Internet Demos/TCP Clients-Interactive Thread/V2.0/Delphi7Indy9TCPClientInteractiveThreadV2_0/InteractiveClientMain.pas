...
(*
This demo shows how to send commands to a TCPClient in an interactive thread that the user can control. It then sends them to a
...
uses
  ...
  IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient, ExtCtrls, IDException;
...
*)
        ...
        begin
            AStream := TFileStream.Create(parameters[0], fmOpenRead + fmShareDenyNone);
            try
