...
uses
  ...
  IDContext, IDThread, IdIOHandlerSocket, IDStack, IDException,
  IdTCPConnection, IdExceptionCore, IdObjs, IdSys, IdCustomTCPServer;
...
procedure TClientSpecificData.TCPClientInsideThreadWorkBegin(ASender: TObject; AWorkMode: TWorkMode; AWorkCountMax: Int64);
    var
...
procedure TClientSpecificData.TCPClientInsideThreadWork(ASender: TObject; AWorkMode: TWorkMode; AWorkCount: Int64);
    var
        ClientSpecificData: TClientSpecificData;
    begin
        if ShowProgress then
