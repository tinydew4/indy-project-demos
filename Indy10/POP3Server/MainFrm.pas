...
uses
  ...
  IdCmdTCPServer, IdExplicitTLSClientServerBase, IdContext, IdCommandHandlers;
...
type
  TfrmMain = class(TForm)
    ...
    procedure IdPOP3Server1Exception(AContext: TIdContext; AException: Exception);
    procedure IdPOP3Server1Connect(AContext: TIdContext);
    procedure IdPOP3Server1CheckUser(AThread: TIdContext; LThread: TIdPOP3ServerContext);
...
// Deletions should be handled at the QUIT event.
 ASender.Context.Connection.IOHandler.WriteLn('+OK message 1 deleted');
end;
...
begin
 ...
 ASender.Reply.SetReply(OK, '40 octets');
 // Now populate ASender.Response with the data to be returned.
 ASender.Response.Add('From: demo@projectindy.org');
 ASender.Response.Add('To: you@yourdomain.com ');
 ASender.Response.Add('Subject: Hello ');
 ASender.Response.Add('');
 ASender.Response.Add('Hello world! This is email body.');
end;
...
procedure TfrmMain.IdPOP3Server1CheckUser(AThread: TIdContext;
...
procedure TfrmMain.IdPOP3Server1Connect(AContext: TIdContext);
begin
...
procedure TfrmMain.IdPOP3Server1Exception(AContext: TIdContext;
